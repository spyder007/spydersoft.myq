...
namespace spydersoft.myq.Model
{
    ...
    public partial class LoginBody :  IEquatable<LoginBody>, IValidatableObject
    {
        ...
        public LoginBody(string username = default(string), string password = default(string))
        {
            // to ensure "username" is required (not null)
            this.Username = username ?? throw new ArgumentNullException("username is a required property for LoginBody and cannot be null");
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for LoginBody and cannot be null");
        }
